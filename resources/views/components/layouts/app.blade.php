...
<body class="antialiased bg-white text-slate-900 selection:bg-primary-500 selection:text-white flex min-h-screen flex-col">
    <header class="sticky top-0 z-50 border-b border-white/10 bg-[#06111f]/95 text-white shadow-[0_8px_30px_rgba(2,8,23,0.12)] backdrop-blur-xl">
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div class="flex min-h-[72px] items-center justify-between gap-6 py-3">
                <a href="/" class="group flex items-center gap-3" aria-label="EliasWorks, inicio">
                    <span class="relative flex h-10 w-10 items-center justify-center overflow-hidden rounded-xl border border-primary-400/20 bg-primary-500/10 text-primary-300 shadow-inner shadow-primary-400/5 transition group-hover:border-primary-400/40 group-hover:bg-primary-500/15">
                        <span class="text-sm font-extrabold tracking-[-0.08em]">EW</span>
                        <span class="absolute bottom-0 left-1/2 h-0.5 w-5 -translate-x-1/2 rounded-full bg-primary-400 shadow-[0_0_14px_rgba(96,165,250,0.8)]"></span>
                    </span>
                    <span>
                        <span class="block text-lg font-extrabold leading-none tracking-tight text-white">EliasWorks</span>
                        <span class="mt-1 block text-[10px] font-semibold uppercase tracking-[0.16em] text-slate-500">Software Engineering</span>
                    </span>
                </a>
                ...
                <div class="hidden items-center gap-3 lg:flex">
                    ...
                    <a href="/contacto" class="inline-flex items-center justify-center rounded-xl border border-primary-400/40 bg-primary-500/10 px-5 py-2.5 text-sm font-semibold text-primary-200 transition hover:border-primary-300/60 hover:bg-primary-500/20 hover:text-white">
                        Hablemos
                ...
                <details class="relative lg:hidden">
                    <summary class="list-none cursor-pointer rounded-xl border border-white/10 bg-white/[0.04] p-2.5 text-slate-200 transition hover:bg-white/[0.08] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary-400" aria-label="Abrir navegación">
                        <svg class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6h16M4 12h16M4 18h16" />
                        </svg>
                    </summary>
                    <nav class="absolute right-0 mt-3 w-64 overflow-hidden rounded-2xl border border-white/10 bg-[#0b1b2d] p-3 shadow-2xl shadow-black/30" aria-label="Navegación móvil">
                        ...
                        <a href="https://github.com/LuisHdezE" target="_blank" rel="noreferrer" class="block rounded-xl px-4 py-3 text-sm font-semibold text-primary-300 hover:bg-primary-500/10">GitHub ↗</a>
                    </nav>
                </details>
            </div>
        </div>
    ...
    <footer class="border-t border-white/10 bg-[#06111f] text-slate-300">
        <div class="mx-auto max-w-7xl px-4 py-14 sm:px-6 lg:px-8">
            <div class="grid gap-10 md:grid-cols-[1.4fr_0.8fr_0.8fr]">
                <div>
                    <a href="/" class="inline-flex items-center gap-3 text-white">
                        <span class="flex h-10 w-10 items-center justify-center rounded-xl border border-white/10 bg-white/[0.05] text-xs font-extrabold text-primary-300">EW</span>
                        <span>
